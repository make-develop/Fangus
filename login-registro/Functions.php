...
public function registerUser($name, $lastname, $dateb, $email, $profession, $tlf, $password) {

  $db = $this -> db;

  if (!empty($name) && !empty($lastname) && !empty($dateb) && !empty($email) && !empty($profession) && !empty($tlf) && !empty($password)) {
      ...
      if ($db -> checkUserExist($email)) {
        ...
        $result = $db -> insertData($name, $lastname, $dateb, $email, $profession, $tlf, $password);
...
public function sendEmail($email,$temp_password){
  ...
  $mail->SMTPAuth = true;
  $mail->Username = 'makedevelop100@gmail.com';
  $mail->Password = 'proyectos1116';
  $mail->SMTPSecure = 'ssl';
  $mail->Port = 465;

  $mail->From = 'makedevelop100@gmail.com';
  $mail->FromName = 'Your Name';
  $mail->addAddress($email, 'Your Name');
 
  $mail->addReplyTo('makedevelop100@gmail.com', 'Your Name');
