  ...
  if(isset($data -> operation)){
    ...
    if(!empty($operation)){
      ...
      if($operation == 'register'){
        ...
        if(isset($data -> user ) && !empty($data -> user) && isset($data -> user -> name) && isset($data -> user -> lastname) && isset($data -> user -> dateb)
          && isset($data -> user -> email) && isset($data -> user -> profession) && isset($data -> user -> tlf) && isset($data -> user -> password)){
          ...
          if ($fun -> isEmailValid($email)) {
            ...
            echo $fun -> registerUser($name, $lastname, $dateb, $email, $profession, $tlf, $password);
